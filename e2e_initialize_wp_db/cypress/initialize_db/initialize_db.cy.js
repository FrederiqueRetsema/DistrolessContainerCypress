...
describe('Set database settings', () => {
  it('Input database name', () => {
    ...
    cy.get('[aria-describedby="dbname-desc"]')
	    .clear()
  ...
  it('Input user name', () => {
    cy.get('[aria-describedby="uname-desc"]')
	    .clear()
      .type(Cypress.env('databaseUserId'))
      .should('have.value', Cypress.env('databaseUserId'));
  });

  it('Input password', () => {
    cy.get('[aria-describedby="pwd-desc"]')
  	  .clear()
      .type(Cypress.env('wordpressPassword'))
      .should('have.value', Cypress.env('wordpressPassword'));
  });

  it('Input database host', () => {
    cy.get('[aria-describedby="dbhost-desc"]')
	    .clear()
  ...
  it('Input prefix', () => {
    cy.get('[aria-describedby="prefix-desc"]')
	    .clear()
      .type('wp_')
...
describe('Set blog site settings', () => {
  ...
  it('Set user login name', () => {
    cy.get('input#user_login')
      ...
      .should('have.value', Cypress.env('wordpressUserId'));
  });
  
  it('Set user login wordpressPassword', () => {
    cy.get('[aria-describedby="pass-strength-result"]')
      .clear()
      .type(Cypress.env('wordpressPassword'))
      .should('have.value', Cypress.env('wordpressPassword'));
  });
